...
import com.kgaisin.lunchchooser.utils.ValidationUtil;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     * HTTP 404 Not Found
     *
     * @param ex      the com.kgaisin.lunchchooser.RestaurantNotFoundException
     * @param request the current request
     * @return a {@code ResponseEntity} instance
     */
    ...
    /**
     * Handle DataNotPresentException.
     * HTTP 409 Conflict.
     *
     * @param ex the DataNotPresentException
     * @return a {@code ResponseEntity} instance
     */
    @ExceptionHandler(DataNotPresentException.class) //409
    public final ResponseEntity<Object> handleDataNotFound(DataNotPresentException ex, WebRequest request) {
